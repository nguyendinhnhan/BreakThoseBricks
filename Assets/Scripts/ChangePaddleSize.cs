...
public class ChangePaddleSize : BasePowerUp {
	...
	//Can also be nagative to shrink the paddle
	...
	protected override void OnPickup () {
		//Call the default behavior of the base class first
		base.OnPickup();

		//Then do the powerup specific behavior, changing the size in this case
